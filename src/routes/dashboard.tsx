      ...
      <section className="mb-8 grid gap-4 rounded-xl border border-border bg-card p-4 sm:grid-cols-3">
        ...
        <div className="text-sm">
          ...
          <div className="relative isolate grid grid-cols-3 overflow-hidden rounded-md border border-input bg-background/45 p-0">
            <span
              aria-hidden
              className={`pointer-events-none absolute inset-y-0 left-0 z-0 w-1/3 border bg-primary shadow-[inset_0_1px_0_oklch(1_0_0_/_70%),0_0_7px_oklch(0.67_0.17_232_/_52%),0_1px_2px_oklch(0.25_0.06_235_/_18%)] transition-[transform,border-radius,box-shadow] duration-200 ease-out ${
